...
from diffsvc.modules.parallel_wavegan.models import ParallelWaveGANGenerator
from diffsvc.modules.parallel_wavegan.utils import read_hdf5
from diffsvc.network.vocoders.base_vocoder import BaseVocoder, register_vocoder
...
class PWG(BaseVocoder):
    ...
    def wav2spec(wav_fn, return_linear=False):
        from diffsvc.pre.data_gen_utils import process_utterance
